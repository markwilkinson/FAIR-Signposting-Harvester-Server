...
#    key :produces, ['application/json']
  ...
  SWAGGERED_CLASSES = [ ErrorModel, LinksResponse, JSONResponse, LinkedDataResponse, JSONWarnings, LinkedDataResponseNegotiation, JSONDataResponseNegotiation, JSONWarningsFull, self].freeze
